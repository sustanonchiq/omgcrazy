	...
	+(function (t) {
				...
				if (!s.is('.disabled, :disabled')) {
					...
					if ((e(), !r)) {
						'ontouchstart' in document.documentElement &&
							...
							t('<div class="dropdown-backdrop"/>').insertAfter(t(this)).on('click', e)
						var a = {
							relatedTarget: this,
						}
		...
		;(t.fn.dropdown = o),
			...
			t(document)
				...
				.on('keydown.bs.dropdown.data-api', n + ', [role="menu"], [role="listbox"]', r.prototype.keydown)
	})(jQuery),
	+(function (t) {
		'use strict'
		function e(e, o) {
		...
		function e(e) {
			return this.each(function () {
				var o = t(this),
					...
					n = 'object' == typeof e && e
				;(s || 'destroy' != e) &&
					(s || o.data('bs.tooltip', (s = new i(this, n))), 'string' == typeof e && s[e]())
			})
		}
		var i = function (t, e) {
		...
		;(i.VERSION = '3.2.0'),
			...
			(i.prototype.init = function (e, i, o) {
				;(this.enabled = !0),
					...
					(this.$viewport =
						this.options.viewport && t(this.options.viewport.selector || this.options.viewport))
			...
			(i.prototype.getTitle = function () {
				var t,
					...
					i = this.options
				return (t =
					e.attr('data-original-title') || ('function' == typeof i.title ? i.title.call(e[0]) : i.title))
			}),
		...
		function e(e) {
			return this.each(function () {
				var o = t(this),
					...
					n = 'object' == typeof e && e
				;(s || 'destroy' != e) &&
					(s || o.data('bs.popover', (s = new i(this, n))), 'string' == typeof e && s[e]())
			})
		}
		var i = function (t, e) {
		...
		;(i.VERSION = '3.2.0'),
			...
			(i.prototype.getContent = function () {
				var t = this.$element,
					e = this.options
				return (
					t.attr('data-content') || ('function' == typeof e.content ? e.content.call(t[0]) : e.content)
				)
			}),
			(i.prototype.arrow = function () {
